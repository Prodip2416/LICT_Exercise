...
namespace BDJArticle15.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        bdjArticleEntities db = new bdjArticleEntities();
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            var user = db.Users.Where(usr => usr.Email == model.Email && usr.Password == model.Password).First();
            ...
            else
            {
                ...
                if(user.UsersAdmin != null)
                {
                    Session["type"] = "Admin";
                }
                else if(user.UsersAuthor != null)
                {
                    Session["type"] = "Author";
                }
                else
