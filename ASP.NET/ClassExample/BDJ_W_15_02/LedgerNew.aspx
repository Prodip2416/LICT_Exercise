<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="LedgerNew.aspx.cs" Inherits="BDJ_W_15_02.LedgerNew" Theme="Red" %>
    ...
    <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" DataKeyNames="Id" DataSourceID="SqlDataSource1" DefaultMode="Insert" ForeColor="Black" GridLines="Horizontal" Height="50px" Width="125px" OnItemInserting="DetailsView1_ItemInserting" OnItemInserted="DetailsView1_ItemInserted">
        ...
        <Fields>
            ...
            <asp:TemplateField HeaderText="createDate" SortExpression="createDate">
                ...
                <InsertItemTemplate>
                    <asp:TextBox ID="TextBox10" runat="server" Text='<%# Bind("createDate") %>'></asp:TextBox>
                    <ajaxToolkit:CalendarExtender ID="TextBox10_CalendarExtender" runat="server" BehaviorID="TextBox10_CalendarExtender" TargetControlID="TextBox10" />
                </InsertItemTemplate>
                <ItemTemplate>
